...
namespace DAL
{
    public class DonDatHangAccess : DataConnect
    {

        // Hiển thị danh sách Đơn Đặt Hàng
        #region Hiển thị danh sách Đơn Đặt Hàng
        public DataTable HienThiDanhSachDonHang()
        {
            ...
            try
            {
                ...
                SqlDataAdapter dataAdapter = new SqlDataAdapter("SELECT *FROM dbo.DONDH", conn);
        ...
        #region
        public DataTable HienThiDanhSachCTDH()
        {
            ...
            try
            {
                ...
                SqlDataAdapter dataAdapter = new SqlDataAdapter("SELECT *FROM dbo.CTDH", conn);
                DataTable dt = new DataTable();
                dataAdapter.Fill(dt);
        ...
        // Load Ten Nhac Cung Cap
        #region Load Ten Nhac Cung Cap
        public DataTable HienThiTenNhaCC()
        {
            try
            {
                OpenConnection();
