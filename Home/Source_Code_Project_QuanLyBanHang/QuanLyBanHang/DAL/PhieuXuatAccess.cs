...
namespace DAL
{
    public class PhieuXuatAccess : DataConnect
    {
        ...
        public DataTable HienThiPhieuXuat()
        {
            try
            {
                ...
                SqlDataAdapter sqlDataAdapter = new SqlDataAdapter("SELECT *FROM dbo.PHIEUXUAT", conn);
        ...
        public DataTable HienThiCTPX()
        {
            try
            {
                ...
                SqlDataAdapter sqlDataAdapter = new SqlDataAdapter("SELECT *FROM dbo.CTPX", conn);
        ...
        public DataTable HienThiTenKhachHang()
        {
            try
            {
                OpenConnection();

                SqlDataAdapter sqlDataAdapter = new SqlDataAdapter("SELECT TENKH FROM dbo.KHACHHANG", conn);
        ...
        public DataTable HienThiMaDonHang()
        {
            try
            {
                OpenConnection();
        ...
        public DataTable HienThiSlxTheoMaDh(PhieuXuatHang px)
        {
            try
            {
                OpenConnection();
                ...
                SqlCommand sqlCommand = new SqlCommand();
                sqlCommand.CommandType = CommandType.Text;
                sqlCommand.CommandText = "SELECT SLDH FROM dbo.CTDH WHERE MADH=@madh";
                sqlCommand.Connection = conn;
        ...
        public DataTable HienThiMaSpTheoMaDh(PhieuXuatHang px)
        {
            try
            {
                OpenConnection();
                ...
                SqlCommand sqlCommand = new SqlCommand();
                sqlCommand.CommandType = CommandType.Text;
                sqlCommand.CommandText = "SELECT MASP FROM dbo.CTDH WHERE MADH=@madh";
                sqlCommand.Connection = conn;
        ...
        public DataTable SelectGiaThanhSanPham(PhieuXuatHang px)
        {
            try
            {
                ...
                SqlCommand sqlCommand = new SqlCommand();
                sqlCommand.CommandType = CommandType.Text;
                sqlCommand.CommandText = "SELECT *FROM SANPHAM WHERE MASP=@MASP";
                sqlCommand.Connection = conn;
        ...
        //Loc Tien Thua Theo Tien Khach Dua
        #region
        public DataTable LocTienThua(PhieuXuatHang px)
        {
            try
            {
                ...
                SqlCommand sqlCommand = new SqlCommand();
                sqlCommand.CommandType = CommandType.StoredProcedure;
                sqlCommand.CommandText = "sp_TinhTienThua";

                sqlCommand.Parameters.Add("@MAPX", SqlDbType.Int).Value = px.MaPx;
                sqlCommand.Parameters.Add("@TIENKHACHDUA", SqlDbType.Money).Value = px.TienKhachDua;
