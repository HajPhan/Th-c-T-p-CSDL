...
namespace DAL
{
    public class KhachHangAccess : DataConnect
    {
        public DataTable GetAllCustomer()
        {
            ...
            {
                OpenConnection();
                SqlDataAdapter adapter = new SqlDataAdapter("SELECT *FROM dbo.KHACHHANG", conn);
        ...
        public List<KhachHang> GetAllListCustomer()
        {
            try
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    kh.Sdt = int.Parse(dt.Rows[i][4].ToString());
        ...
        public bool ThemKhachHang(KhachHang kh)
        {
            try
            {
                ...
                command.Parameters.Add("@SDT", SqlDbType.Int).Value = kh.Sdt;
        ...
        public DataTable HienThiReportKhachHang()
        {
            try
            {
                ...
                SqlDataAdapter sqlDataAdapter = new SqlDataAdapter("SELECT *FROM dbo.KHACHHANG", conn);
        ...
        public List<KhachHang> LocDanhSachKhachHang(KhachHang nv)
        {
            try
            {
                ...
                else if (nv.Search == "Số Điện Thoại")
                {
                    ...
                    {
                        KhachHang khs = new KhachHang();
                        khs.Sdt = int.Parse(dt.Rows[i][0].ToString());
        ...
        public List<KhachHang> TimKiemKhachHang(KhachHang kh)
        {
            try
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    khs.Sdt = int.Parse(dt.Rows[i][4].ToString());
