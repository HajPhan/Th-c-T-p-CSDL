...
namespace DAL
{
    public class NhaCungCapAccess : DataConnect
    {
        public DataTable HienThiNhaCungCap()
        {
            ...
            {
                OpenConnection();
                SqlDataAdapter adapter = new SqlDataAdapter("SELECT *FROM dbo.NHACC", conn);
        ...
        public bool ThemNhaCungCap(NhaCungCap ncc)
        {
            try
            {
                ...
                command.Parameters.Add("@SDT", SqlDbType.Int).Value = ncc.Sdt;
        ...
        public DataTable HienThiReporthaCungCap()
        {
            try
            {
                ...
                SqlDataAdapter sqlDataAdapter = new SqlDataAdapter("SELECT *FROM NHACC", conn);
