...
namespace DAL
{
    public class PhieuNhapAccess:DataConnect
    {
        // Hiên thị danh sách Phiếu Nhập
        public DataTable HienThiDanhSachPhieuNhap()
        {
            try
            {
                OpenConnection();

                SqlDataAdapter sqlDataAdapter = new SqlDataAdapter("SELECT *FROM dbo.PHIEUNHAP", conn);
        ...
        public DataTable HienThiDanhSachCTPN()
        {
            try
            {
                OpenConnection();

                SqlDataAdapter sqlDataAdapter = new SqlDataAdapter("SELECT *FROM dbo.CTPN", conn);
        ...
        // Load Tên Nhà Cung Lên ComboBox
        public DataTable HienThiTenNhaCungCap()
        {
            try
            {
                ...
                SqlDataAdapter sqlDataAdapter = new SqlDataAdapter("SELECT TENCC FROM dbo.NHACC", conn);
        ...
        //public List<PhieuNhapHang>HienThiThongTinDonHangChoPhieuNhap(PhieuNhapHang pn)
        //{
        //    try
        //    {
        //        OpenConnection();
        ...
        //        SqlCommand sqlCommand = new SqlCommand();
        //        sqlCommand.CommandType = CommandType.StoredProcedure;
        //        sqlCommand.CommandText = "sp_Select_ThongTinDonHangChoPhieuNhap";
        //        sqlCommand.Connection = conn;
        ...
        //            pnh.TenSp = dt.Rows[i][1].ToString();
